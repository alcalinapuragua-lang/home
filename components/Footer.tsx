...
const Footer: React.FC = () => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white border-t border-gray-100 p-4 z-50 shadow-[0_-5px_15px_rgba(0,0,0,0.05)]">
      <div className="flex justify-between items-center text-cyan-800">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-sm">(81) 99265-7235</span>
        </div>
        <div className="text-[10px] text-gray-400 text-right font-medium leading-tight">
          PWA Alcalina Pura<br/>Recife - PE
        </div>
      </div>
    </footer>
  );
